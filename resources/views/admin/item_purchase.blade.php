					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable" style="width:100%">
						  <thead>
							 ...
							 <th scope="col" width="5px">Item Id</th>
		                    <th scope="col" width="10px">Name</th>
		                    <!-- <th scope="col">Ava: Quantity</th> -->
		                    <th scope="col"width="10px">Quantity</th>
		                    <th scope="col"width="10px">Purchase Quantity</th>
		                    <th scope="col"width="15px">Item price</th>
                        ...
                        <form action="{{URL::to('/updatePurchase')}}/{{$item->item_id}}" method="post">
                        	@csrf
							<tr>
								...
								<td class="center">
									<input type="text" name="update_purchase_quantity" class="form-control input input-sm" value="{{$item->purchase_quantity}}">
								</td>
					  ...
					  <form action="{{URL::to('/completePurchase')}}" method="post">
					  	@csrf
					  		<tr>
					  			<td></td>
					  			<td></td>
					  	...
					  	<td></td>
					  	<td></td>
					  	<td><button class="btn btn-success btn-sm pull-right" type="submit">Complete Purchase</button></td>
					  	</tr>
					  </form>
					</tbody>
					  </table>           
